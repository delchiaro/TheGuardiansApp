...
public class ToolTip {
    ...
    private boolean mRemoveWithClick = true;
    ...
    /**
     * Set true to remove tooltip on click. Default true.
     *
     * @return this ToolTip to build upon.
     */
    public ToolTip withClickRemove(boolean removeTooltipWithClick) {
        this.mRemoveWithClick = removeTooltipWithClick;
        return this;
    }
    ...
    public boolean getRemoveWithClick() {
        return this.mRemoveWithClick;
    }
