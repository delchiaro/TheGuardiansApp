...
public class MyHorizontalScrollPager implements OnTouchListener
{
	...
	public MyHorizontalScrollPager(ScrollView aScrollView, ViewGroup aContentView, ViewGroup[] aFragmentContainer,
